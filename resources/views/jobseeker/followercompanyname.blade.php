   ...
   @if(isset($company) && !isset($company->message))
    @forelse($company as $companies)
        ...
        <div class="well">
          ...
          <a href="{{'/jobseeker/unfollow/'.$companies->employer_id}}" class="btn btn-success">Unfollow</a>
          
          @else
          <a href="{{'/jobseeker/follow/'.$companies->employer_id}}" class="btn btn-warning">Follow</a>
         @endif
        </div>
