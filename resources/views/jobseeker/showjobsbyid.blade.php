...
<div class="row">
      ...
      <div class="col-md-8 col-xs-12">
              ...
              {{Html::image('storage/company_logo/'.$j->companylogo,'Logo',array('style'=>'max-width:150px','class'=>'img img-responsive img-thumbnail'))}}
               @else
                {{Html::image('images/no-logo.png','Logo',array('style'=>'max-width:150px','class'=>'img img-responsive img-thumbnail'))}}
                @endif
        ...
        <div class="col-md-4 hidden-sm hidden-xs">
          ...
          <div class="similar-jobs__content">
           @forelse($relatedJobs as $related)
              ...
              {{Html::image('storage/company_logo/'.$related->clogo,'Logo',array('height'=>'50px','width'=>'50px','class'=>"similar-job__company-img"))}}
               @else
                {{Html::image('images/no-logo.png','Logo',array('height'=>'50px','width'=>'50px','class'=>"similar-job__company-img"))}}
                @endif
              </a>
              </span>
              </div>
