<div class="modal fade" id="trainig_form" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Add Training Information</h4>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="well">
                    ...
                    <p class="text-center">Add Traininig Information</p>
                    {!! Form::open(array('url' =>'/jobseeker/infoupdate', 'name' => '', 'method' => 'post', 'id' => 'training_insert_form')) !!}
                    {{ Form::hidden('action', 'training_insert', array('class' => 'form-control')) }}
                    <meta name="csrf-token" content="{{ csrf_token() }}">

                       
                        <div class="form-group">
                            {{ Form::label('training_title', 'Training title:', ['class' => 'control-label']) }}
                            {{ Form::text('training_title', null, array('class' => 'form-control')) }}
                        </div>
                        <div class="form-group">
