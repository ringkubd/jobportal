<div class="modal fade common-modal" id="education_form" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Academics Information</h4>
        </div>
		...
		<div class='well'>
                    ...
                    {{ Form::text('action', 'education_infoupdate', array('class' => 'form-control hidden',)) }}
                  ...
                  <div class="form-group">
                    ...
                    {{ Form::select('lavelofeducation_id',$levelofeducation,['-1'=>'select group or mejor'],['class' => 'form-control', 'id' => 'lavelofeducation_id']) }}
                  </div>
                
                <div class="form-group">
                {{ Form::label('exam_title_id', 'Examtitle:', ['class' => 'control-label']) }}
                {{Form::select('exam_title_id',['-1'=>'Select exam title'],NULL,['class' => 'form-control', 'id' => 'exam_title_id'])}}
                </div>
                <div class="form-group">
                {{ Form::label('groupormajor_id', 'Group or major:', ['class' => 'control-label']) }}
                {{Form::select('groupormajor_id',["-1"=>'select group or mejor'],NULL,['class' => 'form-control','id'=>'groupormajor_id'])}}
                </div>
                ...
                {{Form::text('marks','',['class' => 'form-control'])}}
                </div>
                <div class="form-group">
                ...
                {{Form::text('passing_year','',['class' => 'form-control'])}}
                </div>
         
                  <div class="form-group">
                      {{ Form::label('duration','Duration:', ['class' => 'control-label']) }}
                      {{ Form::text('duration',"", array('class' => 'form-control', 'placeholder'=>'Amount in BDT')) }} Tk./Month
                  </div>
                  <div class="form-group">
                      {{ Form::label('achievment', 'Achievment:', ['class' => 'control-label']) }}
                      {{ Form::text('achievment','', array('class' => 'form-control', 'placeholder'=>'Amount in BDT')) }} Tk./Month
                  </div>
