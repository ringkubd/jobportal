...
<div class="col-md-8" id="Posted_job_details">
          <h1 class="text-center">Published Job: {{$jobprofile_details !=false?$jobprofile_details->total($jobprofile_details):'0'}}</h1>
            ...
            <div class="well">
                <div class="panel panel-primary">
                  <div class="panel-heading">
                   <h2 class="panel-title">Published Job title:<span class="jobtitle">{{$jobprofile_posted->jobtitle}}</span><a href="#" id="edit_jobs" class="pull-right" data-toggle="modal" data-target="#myModal"><i class="fa fa-edit" aria-hidden="true"></i>
</a></h2>           
                  </div>
                  ...
                  <div class="panel-body">
            		...
            		<table class="table table-responsive table-striped well">
                           <tr>
                            ...
                            <tr>
                                <th><button class="btn btn-success pull-right job_unpublished" value="{{$jobprofile_posted->id}}">Unpublished</button></th>
            ...
            @else
            <h1 class="text-center alert-danger">NO JOB PUBLISHED YET</h1>
...
//:::::::::job un published start:::::::::::::
$(document).on('click','.job_unpublished', function() {
    var currentpage=$('.currentpage').val();
        var pathurl=$('.pathurl').val();
        var lastpage=$('.lastpage').val();
        var prepageurl=$('.prepageurl').val();
        var nextpageurl=$('.nextpageurl').val();
        var job_unpub_id=$(this).val();
